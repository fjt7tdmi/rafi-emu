...
MemoryTraceWriterImpl::MemoryTraceWriterImpl(void* buffer, int64_t bufferSize)
    : m_pBuffer(buffer)
    , m_BufferSize(bufferSize)
{
}

MemoryTraceWriterImpl::~MemoryTraceWriterImpl()
{
}

void MemoryTraceWriterImpl::Write(void* buffer, int64_t size)
{
