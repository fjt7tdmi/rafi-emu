...
bool CycleComparator::AreMatched(const CycleView& expect, const CycleView& actual) const
{
...
void CycleComparator::PrintDiff(const CycleView& expect, const CycleView& actual) const
{
